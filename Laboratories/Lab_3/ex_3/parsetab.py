...
_lr_productions = [
  ...
  ('prog_ok -> dec_prot_list function_list','prog_ok',2,'p_prog_ok','parser.py',31),
  ('prog_ok -> function_list','prog_ok',1,'p_prog_ok','parser.py',32),
  ('dec_prot_list -> dec_prot_list dec_prot','dec_prot_list',2,'p_dec_prot_list','parser.py',38),
  ('dec_prot_list -> dec_prot','dec_prot_list',1,'p_dec_prot_list','parser.py',39),
  ('dec_prot -> decl','dec_prot',1,'p_dec_prot','parser.py',44),
  ('dec_prot -> function_prot','dec_prot',1,'p_dec_prot','parser.py',45),
  ('function_list -> function','function_list',1,'p_function_list','parser.py',50),
  ('function_list -> function_list function','function_list',2,'p_function_list','parser.py',51),
  ('function_decl -> type pointer RBOPEN parameter_list RBCLOSED','function_decl',5,'p_function_decl','parser.py',56),
  ('function_decl -> void ID RBOPEN parameter_list RBCLOSED','function_decl',5,'p_function_decl','parser.py',57),
  ('function_decl -> STORAGE_SPEC type pointer RBOPEN parameter_list RBCLOSED','function_decl',6,'p_function_decl','parser.py',58),
  ('function_decl -> STORAGE_SPEC void ID RBOPEN parameter_list RBCLOSED','function_decl',6,'p_function_decl','parser.py',59),
  ('function_prot -> function_decl SEMICOLON','function_prot',2,'p_function_prot','parser.py',64),
  ('function -> function_decl CBOPEN function_body CBCLOSED','function',4,'p_function','parser.py',69),
  ('function_body -> empty','function_body',1,'p_function_body','parser.py',74),
  ('function_body -> decl_list stmt_list','function_body',2,'p_function_body','parser.py',75),
  ('parameter_list -> parameter_list COMMA parameter','parameter_list',3,'p_parameter_list','parser.py',80),
  ('parameter_list -> parameter','parameter_list',1,'p_parameter_list','parser.py',81),
  ('parameter_list -> void','parameter_list',1,'p_parameter_list','parser.py',82),
  ('parameter -> type pointer','parameter',2,'p_parameter','parser.py',87),
  ('parameter -> type pointer SBOPEN SBCLOSED','parameter',4,'p_parameter','parser.py',88),
  ('decl_list -> decl','decl_list',1,'p_decl_list','parser.py',93),
  ('decl_list -> decl_list decl','decl_list',2,'p_decl_list','parser.py',94),
  ('decl -> type id_list SEMICOLON','decl',3,'p_decl','parser.py',98),
  ('decl -> STORAGE_SPEC type id_list SEMICOLON','decl',4,'p_decl','parser.py',99),
  ('id_list -> id_list COMMA ident','id_list',3,'p_id_list','parser.py',104),
  ('id_list -> ident','id_list',1,'p_id_list','parser.py',105),
  ('ident -> pointer','ident',1,'p_ident','parser.py',110),
  ('ident -> pointer SBOPEN CONST SBCLOSED','ident',4,'p_ident','parser.py',111),
  ('ident -> pointer EQUALS CONST','ident',3,'p_ident','parser.py',112),
  ('ident -> pointer EQUALS MINUS CONST','ident',4,'p_ident','parser.py',113),
  ('ident -> pointer SBOPEN SBCLOSED EQUALS CBOPEN const_list CBCLOSED','ident',7,'p_ident','parser.py',114),
  ('ident -> pointer SBOPEN SBCLOSED EQUALS CBOPEN string_const_list CBCLOSED','ident',7,'p_ident','parser.py',115),
  ('pointer -> TIMES pointer','pointer',2,'p_pointer','parser.py',120),
  ('pointer -> ID','pointer',1,'p_pointer','parser.py',121),
  ('const_list -> const_list COMMA CONST','const_list',3,'p_const_list','parser.py',126),
  ('const_list -> CONST','const_list',1,'p_const_list','parser.py',127),
  ('string_const_list -> string_const_list COMMA STRINGCONST','string_const_list',3,'p_string_const_list','parser.py',132),
  ('string_const_list -> STRINGCONST','string_const_list',1,'p_string_const_list','parser.py',133),
  ('void -> VOID','void',1,'p_void','parser.py',138),
  ('void -> empty','void',1,'p_void','parser.py',139),
  ('type -> SIGN_MODIFIER TYPE','type',2,'p_type','parser.py',144),
  ('type -> LENG_MODIFIER TYPE','type',2,'p_type','parser.py',145),
  ('type -> SIGN_MODIFIER LENG_MODIFIER TYPE','type',3,'p_type','parser.py',146),
  ('type -> LENG_MODIFIER','type',1,'p_type','parser.py',147),
  ('type -> TYPE','type',1,'p_type','parser.py',148),
  ('stmt_list -> stmts','stmt_list',1,'p_stmt_list','parser.py',153),
  ('stmt_list -> empty','stmt_list',1,'p_stmt_list','parser.py',154),
  ('stmts -> stmts stmt','stmts',2,'p_stmts','parser.py',159),
  ('stmts -> stmt','stmts',1,'p_stmts','parser.py',160),
  ('block -> CBOPEN stmt_list CBCLOSED','block',3,'p_block','parser.py',165),
  ('stmt -> assign_stmt SEMICOLON','stmt',2,'p_stmt','parser.py',170),
  ('stmt -> if_stmt','stmt',1,'p_stmt','parser.py',171),
  ('stmt -> while_stmt','stmt',1,'p_stmt','parser.py',172),
  ('stmt -> block','stmt',1,'p_stmt','parser.py',173),
  ('stmt -> BREAK SEMICOLON','stmt',2,'p_stmt','parser.py',174),
  ('stmt -> return_stmt SEMICOLON','stmt',2,'p_stmt','parser.py',175),
  ('stmt -> for_stmt','stmt',1,'p_stmt','parser.py',176),
  ('stmt -> switch_stmt','stmt',1,'p_stmt','parser.py',177),
  ('stmt -> SEMICOLON','stmt',1,'p_stmt','parser.py',178),
  ('assign_stmt -> ID EQUALS expr','assign_stmt',3,'p_assign_stmt','parser.py',183),
  ('assign_stmt -> ID ASSOP expr','assign_stmt',3,'p_assign_stmt','parser.py',184),
  ('assign_stmt -> expr','assign_stmt',1,'p_assign_stmt','parser.py',185),
  ('term -> ID','term',1,'p_term','parser.py',191),
  ('term -> CONST','term',1,'p_term','parser.py',192),
  ('term -> ID RBOPEN arg_list RBCLOSED','term',4,'p_term','parser.py',193),
  ('term -> ID SBOPEN CONST SBCLOSED','term',4,'p_term','parser.py',194),
  ('term -> ID SBOPEN ID SBCLOSED','term',4,'p_term','parser.py',195),
  ('arg_list -> args','arg_list',1,'p_arg_list','parser.py',200),
  ('arg_list -> empty','arg_list',1,'p_arg_list','parser.py',201),
  ('args -> args COMMA arg','args',3,'p_args','parser.py',206),
  ('args -> arg','args',1,'p_args','parser.py',207),
  ('arg -> term','arg',1,'p_arg','parser.py',212),
  ('arg -> STRINGCONST','arg',1,'p_arg','parser.py',213),
  ('expr -> expr PLUS expr','expr',3,'p_expr','parser.py',219),
  ('expr -> expr MINUS expr','expr',3,'p_expr','parser.py',220),
  ('expr -> expr DIVIDE expr','expr',3,'p_expr','parser.py',221),
  ('expr -> expr TIMES expr','expr',3,'p_expr','parser.py',222),
  ('expr -> expr MOD expr','expr',3,'p_expr','parser.py',223),
  ('expr -> expr INCR','expr',2,'p_expr','parser.py',224),
  ('expr -> INCR expr','expr',2,'p_expr','parser.py',225),
  ('expr -> expr DECR','expr',2,'p_expr','parser.py',226),
  ('expr -> DECR expr','expr',2,'p_expr','parser.py',227),
  ('expr -> RBOPEN expr RBCLOSED','expr',3,'p_expr','parser.py',228),
  ('expr -> MINUS expr','expr',2,'p_expr','parser.py',229),
  ('expr -> PLUS expr','expr',2,'p_expr','parser.py',230),
  ('expr -> term','expr',1,'p_expr','parser.py',231),
  ('if_stmt -> IF RBOPEN cond RBCLOSED stmt','if_stmt',5,'p_if_stmt','parser.py',236),
  ('if_stmt -> IF RBOPEN cond RBCLOSED stmt ELSE stmt','if_stmt',7,'p_if_stmt','parser.py',237),
  ('cond -> cond LOGOP cond','cond',3,'p_cond','parser.py',242),
  ('cond -> RBOPEN cond RBCLOSED','cond',3,'p_cond','parser.py',243),
  ('cond -> comparison','cond',1,'p_cond','parser.py',244),
  ('cond -> expr','cond',1,'p_cond','parser.py',245),
  ('comparison -> expr RELOP expr','comparison',3,'p_comparison','parser.py',250),
  ('while_stmt -> WHILE RBOPEN cond RBCLOSED stmt','while_stmt',5,'p_while_stmt','parser.py',255),
  ('for_stmt -> FOR RBOPEN expr_list SEMICOLON cond SEMICOLON expr_list RBCLOSED stmt','for_stmt',9,'p_for_stmt','parser.py',260),
  ('expr_list -> expr_list COMMA assign_stmt','expr_list',3,'p_expr_list','parser.py',265),
  ('expr_list -> assign_stmt','expr_list',1,'p_expr_list','parser.py',266),
  ('return_stmt -> RETURN expr','return_stmt',2,'p_return_stmt','parser.py',271),
  ('return_stmt -> RETURN','return_stmt',1,'p_return_stmt','parser.py',272),
  ('switch_stmt -> SWITCH RBOPEN ID RBCLOSED CBOPEN case_list CBCLOSED','switch_stmt',7,'p_switch_stmt','parser.py',277),
  ('switch_stmt -> SWITCH RBOPEN ID RBCLOSED CBOPEN case_list default_stmt CBCLOSED','switch_stmt',8,'p_switch_stmt','parser.py',278),
  ('case_list -> case_list case_stmt','case_list',2,'p_case_list','parser.py',283),
  ('case_list -> case_stmt','case_list',1,'p_case_list','parser.py',284),
  ('case_stmt -> CASE CONST COLON stmt_list','case_stmt',4,'p_case_stmt','parser.py',289),
  ('default_stmt -> DEFAULT COLON stmt_list','default_stmt',3,'p_default_stmt','parser.py',294),
