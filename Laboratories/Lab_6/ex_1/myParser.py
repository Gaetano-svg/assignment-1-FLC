...
class MyParser:
    ...
    def p_print_error(self,p):
        ...
        print("Error in print instruction ( row:", p[2].lineno, ", column:", self.lexer.find_column(p[2].lexer.lexdata, p[2]),")")
    ...
    def p_if(self,p):
        ...
        if(len(p) == 8):
            if(p[5] == 'else'):
                ...
                print("Error, else expected in if instruction ( row:", p[5].lineno, ", column:", self.lexer.find_column(p[5].lexer.lexdata, p[5]),")" )
    ...
    def p_while_condition_error(self,p):
        ...
        if(p[3] == ')'):
            if(p[1] == '('):
                print("Error in while condition ( row:", p[2].lineno, ", column:", self.lexer.find_column(p[2].lexer.lexdata, p[2]),")" )

            else:
                print("Error ( expected in while instruction ( row:", p[1].lineno, ", column:", self.lexer.find_column(p[1].lexer.lexdata, p[1]),")")
    
        else:
            print( "Error ) expected in while instruction ( row:", p[3].lineno, ", column:", self.lexer.find_column(p[3].lexer.lexdata, p[3]),")")
