...
_lr_productions = [
  ...
  ('prog -> decl_list stmt_list','prog',2,'p_prog','myParser.py',118),
  ('decl_list -> decl_list decl','decl_list',2,'p_decl_list','myParser.py',139),
  ('decl_list -> <empty>','decl_list',0,'p_decl_list','myParser.py',140),
  ('decl -> type var_list S','decl',3,'p_decl','myParser.py',145),
  ('decl -> type error S','decl',3,'p_decl_error','myParser.py',151),
  ('decl -> type var_list error','decl',3,'p_decl_error','myParser.py',152),
  ('type -> INT_TYPE','type',1,'p_type','myParser.py',163),
  ('type -> DOUBLE_TYPE','type',1,'p_type','myParser.py',164),
  ('m_copy -> empty','m_copy',1,'p_m_copy','myParser.py',175),
  ('var_list -> var','var_list',1,'p_var_list','myParser.py',183),
  ('var_list -> var_list CM m_copy var','var_list',4,'p_var_list','myParser.py',184),
  ('var -> ID','var',1,'p_var','myParser.py',197),
  ('var -> ID SO INT SC','var',4,'p_var','myParser.py',198),
  ('stmt_list -> stmt_list stmt','stmt_list',2,'p_stmt_list','myParser.py',225),
  ('stmt_list -> stmt','stmt_list',1,'p_stmt_list','myParser.py',226),
  ('stmt_list -> error stmt','stmt_list',2,'p_stmt_list_error','myParser.py',232),
  ('stmt -> if','stmt',1,'p_stmt','myParser.py',239),
  ('stmt -> while','stmt',1,'p_stmt','myParser.py',240),
  ('stmt -> assignment','stmt',1,'p_stmt','myParser.py',241),
  ('stmt -> print','stmt',1,'p_stmt','myParser.py',242),
  ('stmt -> BO stmt_list BC','stmt',3,'p_stmt','myParser.py',243),
  ('stmt -> BO stmt_list error BC','stmt',4,'p_stmt_error','myParser.py',248),
  ('stmt -> BO error BC','stmt',3,'p_stmt_error','myParser.py',249),
  ('stmt -> error S','stmt',2,'p_stmt_error','myParser.py',250),
  ('assignment -> id S','assignment',2,'p_assignment','myParser.py',265),
  ('assignment -> id EQ exp S','assignment',4,'p_assignment','myParser.py',266),
  ('assignment -> id EQ error S','assignment',4,'p_assignment_error','myParser.py',280),
  ('assignment -> error EQ exp S','assignment',4,'p_assignment_error','myParser.py',281),
  ('assignment -> id EQ exp error','assignment',4,'p_assignment_error','myParser.py',282),
  ('print -> PRINT id S','print',3,'p_print','myParser.py',298),
  ('print -> PRINT error S','print',3,'p_print_error','myParser.py',308),
  ('if -> IF if_condition nt0_if stmt ELSE nt1_if stmt','if',7,'p_if','myParser.py',316),
  ('if -> IF if_condition nt0_if stmt','if',4,'p_if','myParser.py',317),
  ('if -> IF if_condition nt0_if stmt error nt1_if stmt','if',7,'p_if','myParser.py',318),
  ('if_condition -> RO exp RC','if_condition',3,'p_if_condition','myParser.py',332),
  ('if_condition -> RO error RC','if_condition',3,'p_if_condition_error','myParser.py',340),
  ('if_condition -> error exp RC','if_condition',3,'p_if_condition_error','myParser.py',341),
  ('if_condition -> RO exp error','if_condition',3,'p_if_condition_error','myParser.py',342),
  ('nt0_if -> empty','nt0_if',1,'p_nt0_if','myParser.py',357),
  ('nt1_if -> empty','nt1_if',1,'p_nt1_if','myParser.py',366),
  ('while -> WHILE while_condition nt0_while stmt','while',4,'p_while','myParser.py',377),
  ('while_condition -> RO exp RC','while_condition',3,'p_while_condition','myParser.py',388),
  ('while_condition -> RO error RC','while_condition',3,'p_while_condition_error','myParser.py',396),
  ('while_condition -> error exp RC','while_condition',3,'p_while_condition_error','myParser.py',397),
  ('while_condition -> RO exp error','while_condition',3,'p_while_condition_error','myParser.py',398),
  ('nt0_while -> empty','nt0_while',1,'p_nt0_while','myParser.py',413),
  ('exp_int -> INT','exp_int',1,'p_exp_int','myParser.py',426),
  ('exp_int -> MINUS INT','exp_int',2,'p_exp_int','myParser.py',427),
  ('exp_double -> DOUBLE','exp_double',1,'p_exp_double','myParser.py',438),
  ('exp_double -> MINUS DOUBLE','exp_double',2,'p_exp_double','myParser.py',439),
  ('exp -> exp AND exp','exp',3,'p_exp','myParser.py',451),
  ('exp -> exp OR exp','exp',3,'p_exp','myParser.py',452),
  ('exp -> NOT exp','exp',2,'p_exp','myParser.py',453),
  ('exp -> exp EQ EQ exp','exp',4,'p_exp','myParser.py',454),
  ('exp -> exp MIN exp','exp',3,'p_exp','myParser.py',455),
  ('exp -> exp MAJ exp','exp',3,'p_exp','myParser.py',456),
  ('exp -> exp MAJ_EQ exp','exp',3,'p_exp','myParser.py',457),
  ('exp -> exp EQ_MAJ exp','exp',3,'p_exp','myParser.py',458),
  ('exp -> exp MIN_EQ exp','exp',3,'p_exp','myParser.py',459),
  ('exp -> exp EQ_MIN exp','exp',3,'p_exp','myParser.py',460),
  ('exp -> exp PLUS exp','exp',3,'p_exp','myParser.py',461),
  ('exp -> exp MINUS exp','exp',3,'p_exp','myParser.py',462),
  ('exp -> exp STAR exp','exp',3,'p_exp','myParser.py',463),
  ('exp -> exp DIV exp','exp',3,'p_exp','myParser.py',464),
  ('exp -> RO exp RC','exp',3,'p_exp','myParser.py',465),
  ('exp -> exp_double','exp',1,'p_exp','myParser.py',466),
  ('exp -> exp_int','exp',1,'p_exp','myParser.py',467),
  ('exp -> id','exp',1,'p_exp','myParser.py',468),
  ('exp -> RO error RC','exp',3,'p_exp_error','myParser.py',524),
  ('id -> ID','id',1,'p_id','myParser.py',531),
  ('id -> ID SO INT SC','id',4,'p_id','myParser.py',532),
  ('id -> ID SO ID SC','id',4,'p_id','myParser.py',533),
